...
Slider.prototype = {
  ...
  /**
   * Injects the css into the dom, if required
   */
  injectCssIntoDom: function () {
    if (!___injected) {
      var domStyle = document.createElement("style");
      domStyle.id = ___styleId;
      domStyle.textContent = ___css;
